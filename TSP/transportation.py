...
def runMultiVehicleOptimzation(key,num_vehicles,algo,manuf_cntr,distb_cntr1,distb_cntr2,distb_cntr3,distb_cntr4,
    ...
    if algo=="PATH_CHEAPEST_ARC":
      search_parameters.first_solution_strategy = (routing_enums_pb2.FirstSolutionStrategy.PATH_CHEAPEST_ARC)
    elif algo=="GLOBAL_CHEAPEST_ARC":
    ...
    elif algo=="OBJECTIVE_TABU_SEARCH":
    ...
    #google or tool common error counter
    for _ in routes:
      for __ in range(len(_)):
        if _[__] not in range(0,8):
          _[__]=0
          # return runMultiVehicleOptimzation(key,num_vehicles)
    print("Routes Matrix = ")
    print(routes)
    print(num_vehicles)
    ...
    optimizedResp = {"routesArr":routes,"routesLen":route_lengths,"constraints":{"n_veh":num_vehicles},"totdist":sum(route_lengths)}
